  ...
  return (
    <ScrollView style={[styles.container, isDarkMode && styles.containerDark]}>
      ...
      <View style={[styles.menu, isDarkMode && styles.menuDark]}>
        ...
        <TouchableOpacity style={[styles.menuItem, isDarkMode && styles.menuItemDark]} onPress={() => router.push('/(landlord)/settings' as any)}>
        ...
        <TouchableOpacity style={[styles.menuItem, isDarkMode && styles.menuItemDark]} onPress={() => router.push('/(landlord)/verify-id' as any)}>
        ...
        <TouchableOpacity style={[styles.menuItem, isDarkMode && styles.menuItemDark]} onPress={() => router.push('/(landlord)/change-password' as any)}>
        ...
        <TouchableOpacity style={[styles.menuItem, isDarkMode && styles.menuItemDark]} onPress={() => router.push('/(landlord)/help' as any)}>
        ...
        <TouchableOpacity style={[styles.menuItem, isDarkMode && styles.menuItemDark]} onPress={() => router.push('/(landlord)/legal' as any)}>
