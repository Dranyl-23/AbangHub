...
class User extends Authenticatable
{
    ...
    protected $fillable = ['username', 'email', 'password', 'full_name', 'phone', 'user_type', 'profile_image', 'google_id', 'is_verified', 'email_verified_at', 'id_picture', 'emergency_contact_name', 'emergency_contact_phone'];
