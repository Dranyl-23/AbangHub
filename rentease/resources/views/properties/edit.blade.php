            ...
            <div class="bg-white dark:bg-slate-800 shadow-sm border border-slate-200 dark:border-slate-700 rounded-3xl overflow-hidden">
                <form action="{{ route('properties.update', $property) }}" method="POST" enctype="multipart/form-data" class="p-8">
                    ...
                    <div class="border-b border-slate-200 dark:border-slate-700 pb-8 mb-8">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div class="md:col-span-2">
                                ...
                                <input type="text" name="title" id="title" required value="{{ old('title', $property->title) }}" class="block w-full rounded-xl border-slate-300 dark:border-slate-600 dark:bg-slate-900 dark:text-white focus:ring-rose-500 focus:border-rose-500" placeholder="e.g. Cozy Studio Apartment near USM">
                            ...
                            <div>
                                ...
                                <select name="property_type" id="property_type" required class="block w-full rounded-xl border-slate-300 dark:border-slate-600 dark:bg-slate-900 dark:text-white focus:ring-rose-500 focus:border-rose-500">
                                    ...
                                    <option value="boarding_house" {{ old('property_type', $property->property_type) == 'boarding_house' ? 'selected' : '' }}>Boarding House</option>
                            ...
                            <div>
                                ...
                                <select name="furnishing_status" id="furnishing_status" required class="block w-full rounded-xl border-slate-300 dark:border-slate-600 dark:bg-slate-900 dark:text-white focus:ring-rose-500 focus:border-rose-500">
                                    ...
                                    <option value="furnished" {{ old('furnishing_status', $property->furnishing_status) == 'furnished' ? 'selected' : '' }}>Fully Furnished</option>
                                </select>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="border-b border-slate-200 dark:border-slate-700 pb-8 mb-8">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                            <div>
                                ...
                                <input type="number" step="0.01" name="monthly_rent" id="monthly_rent" required value="{{ old('monthly_rent', $property->monthly_rent) }}" class="block w-full rounded-xl border-slate-300 dark:border-slate-600 dark:bg-slate-900 dark:text-white focus:ring-rose-500 focus:border-rose-500">
                            </div>
                            <div>
                                ...
                                <input type="number" step="0.01" name="security_deposit" id="security_deposit" value="{{ old('security_deposit', $property->security_deposit) }}" class="block w-full rounded-xl border-slate-300 dark:border-slate-600 dark:bg-slate-900 dark:text-white focus:ring-rose-500 focus:border-rose-500">
                            </div>
                            <div>
                            ...
                            <div>
                                ...
                                <input type="number" name="bedrooms" id="bedrooms" required min="0" value="{{ old('bedrooms', $property->bedrooms) }}" class="block w-full rounded-xl border-slate-300 dark:border-slate-600 dark:bg-slate-900 dark:text-white focus:ring-rose-500 focus:border-rose-500">
                            </div>
                            <div>
                                ...
                                <input type="number" name="bathrooms" id="bathrooms" required min="0" value="{{ old('bathrooms', $property->bathrooms) }}" class="block w-full rounded-xl border-slate-300 dark:border-slate-600 dark:bg-slate-900 dark:text-white focus:ring-rose-500 focus:border-rose-500">
                            </div>
                            <div>
                                <label for="floor_area" class="block text-sm font-semibold text-slate-700 dark:text-slate-300 mb-1">Floor Area (sqm)</label>
                                <input type="number" step="0.01" name="floor_area" id="floor_area" min="0" value="{{ old('floor_area', $property->floor_area) }}" class="block w-full rounded-xl border-slate-300 dark:border-slate-600 dark:bg-slate-900 dark:text-white focus:ring-rose-500 focus:border-rose-500">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="border-b border-slate-200 dark:border-slate-700 pb-8 mb-8">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                            <div class="md:col-span-3">
                                ...
                                <input type="text" name="address" id="address" required value="{{ old('address', $property->address) }}" class="block w-full rounded-xl border-slate-300 dark:border-slate-600 dark:bg-slate-900 dark:text-white focus:ring-rose-500 focus:border-rose-500" placeholder="e.g. 123 Main St.">
                            </div>
                            <div>
                                ...
                                <input type="text" name="province" id="province" required value="{{ old('province', $property->province) }}" class="block w-full rounded-xl border-slate-300 dark:border-slate-600 dark:bg-slate-900 dark:text-white focus:ring-rose-500 focus:border-rose-500">
                            </div>
                            <div>
                                ...
                                <input type="text" name="city" id="city" required value="{{ old('city', $property->city) }}" class="block w-full rounded-xl border-slate-300 dark:border-slate-600 dark:bg-slate-900 dark:text-white focus:ring-rose-500 focus:border-rose-500">
                            </div>
                            <div>
                                <label for="barangay" class="block text-sm font-semibold text-slate-700 dark:text-slate-300 mb-1">Barangay</label>
                                <input type="text" name="barangay" id="barangay" value="{{ old('barangay', $property->barangay) }}" class="block w-full rounded-xl border-slate-300 dark:border-slate-600 dark:bg-slate-900 dark:text-white focus:ring-rose-500 focus:border-rose-500">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mb-8">
                        ...
                        <div class="space-y-6">
                            <div>
                                ...
                                <textarea name="description" id="description" rows="5" class="block w-full rounded-xl border-slate-300 dark:border-slate-600 dark:bg-slate-900 dark:text-white focus:ring-rose-500 focus:border-rose-500" placeholder="Tell tenants what makes this place special...">{{ old('description', $property->description) }}</textarea>
                            </div>
                    ...
                    <div class="flex justify-end gap-3 pt-6 border-t border-slate-200 dark:border-slate-700">
                        ...
                        <button type="submit" class="px-6 py-3 rounded-xl bg-rose-600 text-white font-semibold hover:bg-rose-700 shadow-lg shadow-rose-600/30 transition-all hover:-translate-y-0.5">Save Changes</button>
                    </div>
